    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available', models.BooleanField(default=False, verbose_name='Статус позвоноли')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header_image', models.ImageField(blank=True, upload_to='products', verbose_name='Логотип Футера')),
                ('footer_Image', models.ImageField(blank=True, upload_to='products', verbose_name='Логотип Хедера')),
                ...
                ('whatsapp', models.CharField(blank=True, max_length=30, null=True, verbose_name='Ватсап')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, upload_to='products', verbose_name='Картинки')),
                ('rgb_color', colorfield.fields.ColorField(choices=[('#FA0DF3', 'Purple'), ('#000000', 'Black'), ('#141EFF', 'Blue'), ('#FF0D22', 'Red'), ('#00FF00', 'Green'), ('#FA7819', 'Brown'), ('#F7FA0A', 'Yellow'), ('#FFFFFF', 'White')], default='#FFFFFF', image_field=None, max_length=18, samples=None, verbose_name='Выбор цветов')),
